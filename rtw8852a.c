...
static struct rtw_pwr_seq_cmd mac_pwron_8852a[] = {
	{0x0005,
	 RTW_PWR_CUT_ALL_MSK,
	...
	{0x0005,
	 ...
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
	 RTW_PWR_CMD_POLLING, BIT(0), BIT(0)},
	{0x0088,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
	...
	{0x0024,
	 ...
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
	 RTW_PWR_CMD_WRITE, BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0), 0},
	{0x02A0,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
...
static struct rtw_pwr_seq_cmd mac_pwroff_8852a[] = {
	{0x0006,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
...
static struct rtw_pwr_seq_cmd *pwr_on_seq_8852a[] = {
	mac_pwron_8852a,
	NULL
};

static struct rtw_pwr_seq_cmd *pwr_off_seq_8852a[] = {
	mac_pwroff_8852a,
	NULL
};
